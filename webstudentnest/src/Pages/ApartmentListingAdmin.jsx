...
export default function ApartmentListingAdmin({
  ...
  //filter apartments
  const { verifiedApartment, notVerifiedApartment } = UseFilterapartment(
    Apartments || []
  );

  // make change and set filter apartment in setfilterdapartment
  let { handlechangeApartment } = UsechangeApartment(
    tabs,
    Apartments,
    verifiedApartment,
    notVerifiedApartment,
        ...
        <div className="bg-white">
          ...
          {user?.user?.role !== "student" &&
            ...
            !forall && (
              <TogoleButton
                tabs={tabs}
                handlechangeTogoleOnclick={handlechangeTogoleOnclick}
              />
            )}
