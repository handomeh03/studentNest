      ...
      <td className="whitespace-nowrap px-4 py-5 text-sm">
        {userRole === "student" && (
          <button
            ...
            className="flex items-center gap-2 bg-indigo-600 text-white px-3 py-1.5 rounded-lg hover:bg-indigo-700 transition-all shadow-sm active:scale-95 font-medium text-xs"
          >
